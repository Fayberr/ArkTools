# v1.5.7 - 27.06.2026 (d.m.y)
## Changed
- Upgraded Anti-AFK mode with advanced player simulation: relative camera/view rotation, randomized jump/punch action combos, and variable execution intervals to bypass server-side idle kicks.
